...
const Sidebar = () => {
  ...
  return (
    <aside className="fixed inset-y-0 left-0 w-64 bg-stone-50 dark:bg-midnight-950 border-r border-stone-200 dark:border-midnight-800 transition-colors duration-500 z-30 overflow-y-auto">
      {/* Logo Area */}
